          ...
          {({ isSubmitting }) => (
            <Form className='space-y-4'>
              <div className='relative'>
                <label className='block text-gray-700 dark:text-gray-300'>{t('Username')}</label>
                <FaBuilding className='absolute left-3 top-9 text-gray-400' />
                <Field type='text' name='companyName' className='w-full pl-10 pr-3 py-2 border border-gray-300 dark:bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' />
              ...
              <div className='flex space-x-4'>
                <div className='relative flex-1'>
                  ...
                  <Field type='text' name='firstName' className='w-full pl-10 pr-3 py-2 border border-gray-300 dark:bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' />
                  <ErrorMessage name='firstName' component='div' className='text-red-500 text-sm' />
                </div>
                <div className='relative flex-1'>
                  <label className='block text-gray-700 dark:text-gray-300'>{t('Last_Name')}</label>
                  <FaUser className='absolute left-3 top-9 text-gray-400' />
                  <Field type='text' name='lastName' className='w-full pl-10 pr-3 py-2 border border-gray-300 dark:bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' />
              ...
              <div className='relative'>
                ...
                <Field type='email' name='email' className='w-full pl-10 pr-3 py-2 border border-gray-300 dark:bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' />
              ...
              <div className='flex space-x-4'>
                <div className='relative flex-1'>
                  ...
                  <Field type='text' name='phone' className='w-full pl-10 pr-3 py-2 border border-gray-300 dark:bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' />
                ...
                <div className='relative flex-1'>
                  ...
                  <Field type='date' name='dateOfBirth' className='w-full pl-10 pr-3 py-2 border border-gray-300 dark:bg-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' />
