      ...
      <div className="flex flex-col rounded-2xl -mt-10 bg-neutral-100 dark:bg-gray-900 w-full">
        <div className="mt-8 w-full">
          <div className="flex gap-5 flex-col md:flex-row w-full">
            ...
            {/* Main Content Area */}
            <div className="flex flex-col ml-0 md:ml-5 w-full md:w-[82%] mb-20">
              <div className="flex flex-col items-center px-5 md:px-16 pt-20 pb-9 bg-white dark:bg-gray-800 rounded-2xl">
