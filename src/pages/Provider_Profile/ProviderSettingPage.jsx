...
import ProviderProfileSetting from "../../components/provider-components/ProviderProfileSetting";
        ...
        <div className="mt-8 w-full">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0 w-full">
            <div className="flex flex-col w-[18%] max-md:ml-0 max-md:w-full">
              ...
              {/* Dropdown menu */}
              <div
                className={`flex flex-col grow pb-20 text-base tracking-wide leading-6 text-neutral-500 max-md:mt-6 ${
                  isOpen ? "block" : "hidden"
                } md:block`}
              >
                <div className="flex gap-5 justify-between items-start pt-8 pb-14 pl-8 md:w-[250px] w-full bg-white dark:bg-gray-800 rounded-tr-lg max-md:pl-5">
                  <div className="flex flex-col mt-2">
                    ...
                    <div
                      className="flex gap-4 mt-3 whitespace-nowrap font-semibold p-2 rounded-lg bg-Primary text-white dark:hover:text-gray-100 dark:text-gray dark:bg-gray-600 hover:cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300"
            ...
            <div className="flex flex-col ml-5 w-[82%] max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-center px-16 pt-20 pb-9 bg-white dark:bg-gray-800 rounded-2xl max-md:px-5 max-md:max-w-full">
