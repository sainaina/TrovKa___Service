...
import MyService from '../../components/provider-components/MyService';
            ...
            <div className="flex flex-col rounded-2xl -mt-10 bg-neutral-100 dark:bg-gray-900 w-full overflow-x-hidden">
                <div className="mt-8 w-full">
                    <div className="flex gap-5 flex-col md:flex-row w-full">
                            ...
                            <div className={`flex flex-col text-base tracking-wide leading-6 text-neutral-500 ${isOpen ? 'block' : 'hidden'}`}>
                                <div className="flex flex-col gap-5 justify-between items-start pt-8 pb-14 px-8 md:px-0 md:pl-8 w-full bg-white dark:bg-gray-800 rounded-tr-lg">
                                    ...
                                    <div className="flex flex-col mt-2">
                                        ...
                                        <div className="flex gap-4 mt-3 whitespace-nowrap font-semibold p-2 rounded-lg bg-Primary text-white dark:hover:text-gray-100 dark:text-gray dark:bg-gray-600 hover:cursor-pointer hover:shadow-lg hover:scale-105 transition-all duration-300"
                        ...
                        <div className="hidden md:flex flex-col w-full md:w-[18%]">
