...
import SettingComponent from '../../components/admin-component/SettingComponent';
                    ...
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                        ...
                        <div className="flex flex-col ml-5 w-[82%] max-md:ml-0 max-md:w-full">
                            <div className="flex flex-col max-md:mt-6 max-md:max-w-full">
                                ...
                                <div className="flex flex-col items-center px-16  pb-9 bg-white dark:bg-gray-800 rounded-2xl  border-solid border-slate-100 max-md:px-5 max-md:max-w-full">
                                    <div className='-mt-3'>
                                        <SettingComponent />
                                    </div>
                                </div>
