...
import AdminPasswordComponent from '../../components/admin-component/AdminPasswordComponent';
                    ...
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                        <div className="flex flex-col w-[18%] max-md:ml-0 max-md:w-full">
                            <div className="flex flex-col grow pb-20 text-base tracking-wide leading-6 text-neutral-500 max-md:mt-6">
                                <div className="flex gap-5 justify-between items-start pt-8 pb-14 pl-8 w-[250px] dark:bg-gray-800 bg-white rounded-tr-lg max-md:pl-5">
                        ...
                        <div className="flex flex-col ml-5 w-[82%] max-md:ml-0 max-md:w-full">
                            <div className="flex flex-col max-md:mt-6 max-md:max-w-full">
                                ...
                                <div className="flex flex-col items-center px-16  pb-9 dark:bg-gray-800 bg-white rounded-2xl  border-solid border-slate-100 max-md:px-5 max-md:max-w-full">
                                    <div className='-mt-3'>
